  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-yellow-100 mb-4 shadow-sm">
          <Bot className="h-7 w-7 text-blue-600" />
        </div>
        <p className="text-blue-700 font-semibold text-lg mb-2">Start a conversation to generate React components</p>
        <p className="text-green-700 text-sm max-w-sm">I can help you create buttons, forms, cards, and more</p>
      </div>
    );
  }
